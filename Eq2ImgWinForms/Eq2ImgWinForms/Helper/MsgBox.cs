...
namespace xDialog
{
    class MsgBox : Form
    {
        ...
        private MsgBox()
        {
            ...
            this.BackColor = Color.FromArgb(45, 45, 48);// backgroundcolor
            ...
            _plFooter.BackColor = Color.FromArgb(37, 37, 38);// bottom Background
            _plFooter.Height = 80;
        ...
        private static void InitButtons(Buttons buttons)
        {
            ...
            {
                btn.ForeColor = Color.Red;// button text
                btn.Font = new System.Drawing.Font("Segoe UI", 8);
                btn.Padding = new Padding(3);
                btn.FlatStyle = FlatStyle.Flat;
                btn.Height = 30;
                btn.FlatAppearance.BorderColor = Color.FromArgb(99, 99, 98);// button Border
        ...
        private static void InitIcon(Icon icon)
        {
            switch (icon)
            {
                ...
                case MsgBox.Icon.Info:
                    //_msgBox._picIcon.SizeMode = PictureBoxSizeMode.StretchImage;
        ...
        private static Size MessageSize(string message)
        {
            ...
            {
                List<string> groups = new List<string>(); //(from Match m in Regex.Matches(message, ".{1,180}") select m.Value).ToArray();

                foreach (Match item in Regex.Matches(message, ".{1,180}"))
                {
                    groups.Add(item.Value);
                }

                int lines = groups.Count + 1;
                width = 700;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Pen pen = new Pen(Color.FromArgb(191, 219, 255));
